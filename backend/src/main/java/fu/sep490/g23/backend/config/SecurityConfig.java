    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/learning-paths", "/api/learning-paths/**").permitAll()
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/course-thumbnails/**").permitAll()
                        ...
                        .requestMatchers("/api/staff/dashboard", "/api/staff/requests/**")
