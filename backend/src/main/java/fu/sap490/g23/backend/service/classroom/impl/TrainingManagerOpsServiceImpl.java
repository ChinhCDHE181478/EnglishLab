...
import fu.sap490.g23.backend.dto.response.classroom.TrainingManagerActionItemResponse;
import fu.sap490.g23.backend.dto.response.classroom.TrainingManagerClassroomAlertResponse;
...
public class TrainingManagerOpsServiceImpl implements TrainingManagerOpsService {
    ...
    @Override
    public TrainingManagerDashboardResponse getDashboard() {
        ...
        List<TrainingManagerClassroomAlertResponse> classroomAlerts = buildClassroomAlerts();

        return TrainingManagerDashboardResponse.builder()
    ...
    private TrainingManagerActionItemResponse toRegistrationActionItem(ClassroomEnrollment enrollment) {
        ...
        return TrainingManagerActionItemResponse.builder()
                .kind(kind)
                .title(title)
                .subtitle(subtitle)
                ...
                .href("/training-manager/registrations?enrollmentId=" + enrollment.getId())
                .build();
    }

    private TrainingManagerActionItemResponse toChangeRequestActionItem(ClassroomChangeRequest request) {
        return TrainingManagerActionItemResponse.builder()
                ...
                .href("/training-manager/requests?requestId=" + request.getId())
                .build();
    }

    private List<TrainingManagerClassroomAlertResponse> buildClassroomAlerts() {
        LocalDate today = LocalDate.now();
        LocalDate horizon = today.plusDays(14);
        List<TrainingManagerClassroomAlertResponse> alerts = new ArrayList<>();
        ...
        return alerts.stream()
                .sorted(Comparator.comparing(TrainingManagerClassroomAlertResponse::getStartDate, Comparator.nullsLast(Comparator.naturalOrder())))
                .limit(8)
                .toList();
    }

    private TrainingManagerClassroomAlertResponse buildAlert(
        ...
        return TrainingManagerClassroomAlertResponse.builder()
                ...
                .href("/training-manager/classrooms/" + offering.getId())
                .build();
    }
}
