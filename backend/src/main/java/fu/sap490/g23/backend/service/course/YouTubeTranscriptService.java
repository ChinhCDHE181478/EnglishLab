...
public class YouTubeTranscriptService {
    ...
    private List<TranscriptSegmentResponse> fetchTranscriptSegmentsByVideoId(String videoId) {
        try {
            ...
            List<TranscriptSegmentResponse> jsonSegments = fetchJsonTranscript(videoId, selectedTrack);
            if (!jsonSegments.isEmpty()) {
                return jsonSegments;
            }
            return fetchXmlTranscript(videoId, selectedTrack);
        } catch (Exception ex) {
    ...
    private List<TranscriptSegmentResponse> fetchJsonTranscript(String videoId, CaptionTrack track) throws Exception {
        String body = get(buildTimedTextUrl(videoId, track, "json3"));
    ...
    private List<TranscriptSegmentResponse> fetchXmlTranscript(String videoId, CaptionTrack track) throws Exception {
        String body = get(buildTimedTextUrl(videoId, track, null));
        if (body == null || body.isBlank()) {
            return List.of();
        }
    ...
    private String buildTimedTextUrl(String videoId, CaptionTrack track, String format) {
        StringBuilder url = new StringBuilder("https://www.youtube.com/api/timedtext?v=")
                .append(encode(videoId))
                .append("&lang=")
    ...
    private String get(String url) throws Exception {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .header("User-Agent", "EnglishLab/1.0")
                .GET()
                .build();
    ...
    private record CaptionTrack(String languageCode, String name, String kind) {
    }
}
