...
WITH refs AS (
    ...
    SELECT
        ...
        'e2-ielts-practice-tests',
        'Free IELTS practice course curated from public E2 IELTS YouTube videos.',
        'A free online course for Listening, Reading, and Speaking practice. Each video is organized as one module with a study guide, the original video lesson, and follow-up practice.',
        'IELTS 5.5 - 7.0',
        '5 hours 32 minutes',
