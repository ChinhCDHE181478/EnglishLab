export const COURSE_VERSION_STATUS_META = {
  DRAFT: { label: 'Bản nháp', className: 'border-amber-300 bg-amber-50 text-amber-800' },
  PENDING_REVIEW: { label: 'Sẵn sàng xuất bản', className: 'border-sky-200 bg-sky-50 text-sky-700' },
...
export const getCourseVersionLabel = (version) => {
  ...
  if (version.status === 'DRAFT') return `Bản nháp v${version.versionNumber}`;
