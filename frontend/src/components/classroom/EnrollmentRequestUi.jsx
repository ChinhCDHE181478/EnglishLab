...
export const enrollmentStatusMeta = {
  ...
  AWAITING_PLACEMENT_TEST: { label: 'Chờ đánh giá đầu vào', tone: 'bg-amber-50 text-amber-800' },
  PLACEMENT_TEST_COMPLETED: { label: 'Đã có kết quả đầu vào', tone: 'bg-sky-50 text-sky-700' },
  UNDER_STAFF_REVIEW: { label: 'Đang rà soát', tone: 'bg-violet-50 text-violet-700' },
  WAITING_FOR_CLASS: { label: 'Chờ xếp lớp', tone: 'bg-blue-50 text-blue-700' },
