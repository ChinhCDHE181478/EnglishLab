...
import CourseRatingPrompt from '../components/course/CourseRatingPrompt';
...
const CourseHome = () => {
  ...
  const renderMaterials = () => (
    <div>
      ...
      {progressPercent >= 100 ? (
        <div className="mb-5 border border-[#e5d7d9] bg-white px-6 py-5">
          <CourseRatingPrompt
            courseId={course.id}
            onRatingSaved={(response) => setCourse((current) => current ? {
              ...current,
