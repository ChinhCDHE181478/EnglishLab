...
import { CheckCircle2, FileCheck2, RefreshCw, Search, ShieldCheck, XCircle } from 'lucide-react';
        ...
        <div className="grid gap-6 lg:grid-cols-[1.4fr_1fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-5 font-['Manrope'] text-3xl font-black tracking-tight md:text-4xl">
              Duyệt nội dung trước khi lên kệ
            </h2>
            <p className="mt-3 max-w-3xl text-sm leading-7 text-white/75">
              Mỗi khóa học phải đi qua bước rà soát để tránh publish nhầm nội dung thiếu bài học, sai band hoặc chưa đủ chất lượng cho học viên.
            </p>
          </div>
