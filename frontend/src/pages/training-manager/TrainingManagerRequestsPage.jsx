      ...
      <div className={PAGE_BODY_CLASS}>
        ...
        >
          <PageHero
            ...
            subtitle="Không gian xử lý các đề xuất từ giáo viên liên quan đến đổi lịch học, đổi phòng học offline, cập nhật liên kết Lark hoặc hủy buổi học."
            stats={stats}
            action={(
              <Link
              ...
              >
                ...
                Quay lại quản lý đăng ký và học phí
              </Link>
            )}
          />
                    ...
                    <section className="rounded-xl border border-[#e5e7eb] bg-white p-6 shadow-sm space-y-6">
                      ...
                      <div className="rounded-2xl border border-gray-100 bg-gray-50/30 p-5 space-y-2">
                        <h4 className="text-xs font-bold text-[#8b706e] uppercase tracking-wider flex items-center gap-1">
                          ...
                          Lý do thay đổi và đề xuất cụ thể từ giảng viên
                        </h4>
                    ...
                    <section className="rounded-xl border border-[#e5e7eb] bg-white p-6 shadow-sm space-y-6">
                      ...
                      <div className="flex flex-wrap gap-3">
                        ...
                        <button
                          ...
                          type="button"
                        >
                          {checkingConflicts[selected.id] ? 'Đang kiểm tra...' : (
                            <>
