  ...
  return (
    <div className={PAGE_SHELL_CLASS}>
      ...
      <div className={PAGE_BODY_CLASS}>
        ...
        >
          <PageHero
            title="Quản lý đăng ký lớp và học phí"
            subtitle="Không gian nghiệp vụ dành cho điều phối đào tạo để xác nhận giữ chỗ, ghi nhận học phí, kiểm tra trùng lịch và xếp lớp chính thức cho học viên."
            stats={stats}
            action={(
              <Link
                          ...
                          {tuitionHistory.map((payment) => (
                            ...
                            >
                              ...
                              <div className="text-right text-[10px] text-gray-400">
                                ...
                                {payment.createdAt ? <p className="mt-0.5">{formatClassroomDateTime(payment.createdAt)}</p> : null}
                              </div>
                            </div>
                          ))}
                        </div>
